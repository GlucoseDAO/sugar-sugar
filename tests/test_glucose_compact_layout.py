...
def test_compact_layout_shrinks_margins_and_hour_ticks() -> None:
    ...
    assert mobile.layout.margin.b <= 20
    assert desktop.layout.margin.b <= 22
    ...
    assert desktop.layout.xaxis.title.text
...
def test_prediction_and_results_share_the_same_tight_margins() -> None:
    ...
    assert results.layout.margin.b == pred_fig.layout.margin.b == 20
